...
public:
	...
	bool read(uint8_t channel=0, bool gennyMode = false);
	...
	void setHandleSampleMessage(void (*fptr)(uint8_t smp1, uint8_t smp2)) {
		// type: 0x80  NoteOff
		handleSampleMessage = fptr;
	}
...
private:
	...
	void (*handleSampleMessage)(uint8_t smp1, uint8_t smp2);
...
extern usb_midi_class2 usbMIDI2;


class usb_serial_class2 : public Stream
{
public:
...
extern usb_serial_class2 Serial2;
