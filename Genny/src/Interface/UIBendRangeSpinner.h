...
class UIBendRangeSpinner : public CControl, public IControlListener, public GennyInterfaceObject
{
public:
	UIBendRangeSpinner(CPoint point, GennyInterfaceObject* owner);
	~UIBendRangeSpinner(void);
	...
	CLASS_METHODS(UIBendRangeSpinner, CControl)
